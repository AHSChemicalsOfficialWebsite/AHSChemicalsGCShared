...
type EmailMetaData struct {
	...
	Attachments []EmailAttachment `json:"attachments"` //List of attachments for the email
}
...
func (m *EmailMetaData) AddAttachment(attachment EmailAttachment) {
	m.Attachments = append(m.Attachments, attachment)
}

func (m *EmailMetaData) AddAttachments(attachments []EmailAttachment) {
